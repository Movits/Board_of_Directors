    ...
    <div className="tela-config tela-sobre">
      ...
      <section className="cartao-config">
        ...
        <p>
          ...
          são <strong>13 conselheiros</strong> (doze especialistas com áreas diferentes que
          analisam sua ideia, debatem entre si e votam, mais a Presidente do Conselho, que junta
      ...
      <section className="cartao-config">
        ...
        <p>
          ...
          configuração, e o <strong>modo de teste</strong> permite conhecer tudo sem gastar
          nada.
        </p>
        <p>
          <strong>Não quer pagar nada?</strong> O botão{' '}
          <strong>🖥 Rodar de graça no seu chat de IA</strong> gera um prompt pronto para você colar
          no ChatGPT, no Claude, no Gemini ou em outro chat de IA. O conselho roda ali, no plano que
          você já usa, sem custo. Um exemplo que também mexe em código é o{' '}
          <a href="https://claude.com/claude-code" target="_blank" rel="noreferrer">Claude Code</a>:
          ele ainda lê o seu projeto e pode criar as coisas por você. Já a chave de API
          (console.anthropic.com) é um caminho à parte e pago, separado do seu plano do Claude.
        </p>
      </section>
      ...
      <section className="cartao-config">
        ...
        <ol>
          <li>
            ...
            e extraia o arquivo: vira uma pasta <code>brain</code>.
          </li>
          <li>
